//program to stream coordinates file,calculate distance between atoms&output a file with these distances
...
//	{	
//	inputfile >> x[num] >> y[num] >> z[num];
//        num++;//this reads the 1st col number, the 2nd col number, etc, then goes to the next row	 
//        }
